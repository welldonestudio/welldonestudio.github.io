...
export const WalletSelectorContextProvider: React.FC<WalletSelectorProps> = ({ children }) => {
  ...
  const init = useCallback(async () => {
    ...
    const _modal = setupModal(_selector, { contractId: 'mycontract.myaccount8.testnet' });
