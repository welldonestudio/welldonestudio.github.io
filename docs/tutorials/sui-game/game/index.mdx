...
1. an environment for users to play our game
...
For the detailed educational tutorial on full Smart Contract code and descriptions used in the game, how to deploy and run it, and how to use and what is Verifiable Random Function and Dynamic NFTs, please go [this page](https://docs.welldonestudio.io/tutorials/sui-game/).
