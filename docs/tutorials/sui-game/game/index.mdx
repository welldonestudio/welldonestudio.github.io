...
<img src={require('./img/study_u_and_i_1_1.png').default} alt='study_u_and_i_1_1' style={{width: '480px'}}/>
<img src={require('./img/study_u_and_i_1_2.png').default} alt='study_u_and_i_1_2' style={{width: '480px'}}/>
...
<img src={require('./img/study_u_and_i_6_1.png').default} alt='study_u_and_i_6_1' style={{width: '480px'}}/>
<img src={require('./img/study_u_and_i_6_2.png').default} alt='study_u_and_i_6_2' style={{width: '480px'}}/>
